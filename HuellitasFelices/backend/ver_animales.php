<?php
/**
 * API para ver animales (versión para dashboard)
...
try {
    ...
    $rolesPermitidos = ['admin', 'veterinario', 'empleado'];
    ...
    error_log("Error en ver_animales.php (dashboard): " . $e->getMessage());
    ...
    error_log("Error general en ver_animales.php (dashboard): " . $e->getMessage());
    http_response_code(500);
    echo json_encode([
        'success' => false,
        'message' => 'Error en el servidor'
