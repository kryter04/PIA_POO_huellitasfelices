...
function getMenuItemsByRole(role) {
    console.log('Generando menú para rol:', role); // ESTA LÍNEA DEBERÍA APARECER SOLO UNA VEZ
    ...
    console.log('Items filtrados:', filteredItems); // ESTA LÍNEA DEBERÍA MOSTRAR SOLO LOS ITEMS DEL ROL ACTUAL
...
function loadPage(pageName) {
    ...
    // Manejar el caso especial de dashboard
